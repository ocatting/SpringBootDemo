$.namespace("noCrud.common");

noCrud.common = function () {
    var statViewOrderBy = '';
    ...
    return  {
        ...
        handleAjaxResult : function(data) {
            noCrud.common.handleCallback(data);
        },//ajax 处理函数
        ajaxRequestForBasicInfo : function() {
            $.ajax({
                type: 'POST',
                url: noCrud.common.getAjaxUrl(noCrud.common.ajaxuri),
                success: function(data) {
                    noCrud.common.handleAjaxResult(data);
                },
                dataType: "json"
            });
        },
