 ...
 */
@JSONType(typeName="StringColumn")
public class StringColumn extends Column {

	public StringColumn(final String columnName,final String rawData) {
		super(columnName,rawData, Type.STRING, (null == rawData ? 0 : rawData
				.length()));
	}
	...
	public BigInteger asBigInteger() {
		...
		try {
			...
			throw new RuntimeException("String[\"%s\"]不能转为BigInteger ."+this.asString());
		}
	}
	...
	public BigDecimal asBigDecimal() {
		...
		try {
			...
			throw new RuntimeException("String [\"%s\"] 不能转为BigDecimal ."+ this.asString());
		}
	}
