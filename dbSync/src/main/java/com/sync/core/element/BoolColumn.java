...
public class BoolColumn extends Column {
	...
	public BoolColumn(final String columnName,Boolean bool) {
		super(columnName,bool, Type.BOOL, 1);
	}

	public BoolColumn(final String columnName,final String data) {
	...
	public BoolColumn(final String columnName) {
		super(columnName,null, Type.BOOL, 1);
	}
