	    ...
	    <section class="content">
			...
			<div class="row">
				<div class="col-xs-12">
					<div class="box">
			            <div class="box-body" >
			              	<table id="tasklog_list" class="table table-bordered table-striped" width="100%" >
				                <thead>
					            	<tr>
					            		<th name="id" >日志ID</th>
					                	<th name="taskCron" >任务ID</th>
					                  	<th name="taskDesc" >触发时间</th>
                                        <th name="readDbId" >触发编号</th>
                                        <th name="writeDbId" >处理时长(ms)</th>
					                  	<th name="triggerLastTime" >处理结果</th>
					                  	<th>操作</th>
					                </tr>
				                </thead>
				                <tbody></tbody>
...
<script src="${request.contextPath}/static/js/tasklog.index.1.js"></script>
</body>
</html>
