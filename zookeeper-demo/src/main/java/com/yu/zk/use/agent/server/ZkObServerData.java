package com.yu.zk.use.agent.server;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.yu.zk.use.agent.OsBean;
...
/**
 * @Description: zk实现监控服务在线功能
 * @Author Yan XinYu
 **/
@Controller
public class ZkObServerData implements InitializingBean {
    ...
    private Map<String, OsBean> map = new HashMap<>();
    ...
    private List<OsBean> getCurrentOsBeans() {
        List<OsBean> items = zkClient.getChildren(root_path).stream()
                .map(p -> root_path + "/" + p)
